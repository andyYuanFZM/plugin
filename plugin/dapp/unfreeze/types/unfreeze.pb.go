...
type DecreaseAmount struct {
	Period               int64    `protobuf:"varint,1,opt,name=period,proto3" json:"period,omitempty"`
	TenThousandth        int64    `protobuf:"varint,2,opt,name=tenThousandth,proto3" json:"tenThousandth,omitempty"`
	FristDecreaseAmount  int64    `protobuf:"varint,3,opt,name=fristDecreaseAmount,proto3" json:"fristDecreaseAmount,omitempty"`
...
func (m *DecreaseAmount) GetFristDecreaseAmount() int64 {
	if m != nil {
		return m.FristDecreaseAmount
	}
	return 0
}
...
var fileDescriptor_6caa0554cb0b9167 = []byte{
	...
	0x0d, 0x7a, 0x7f, 0x3b, 0x30, 0xb0, 0xfb, 0x73, 0x37, 0x42, 0xf2, 0x10, 0xee, 0xcd, 0x05, 0x4f,
	...
	0x01, 0x00, 0x00, 0xff, 0xff, 0x97, 0x9b, 0x23, 0xc4, 0x32, 0x0c, 0x00, 0x00,
}
